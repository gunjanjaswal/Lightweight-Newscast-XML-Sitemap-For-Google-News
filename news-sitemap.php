<?php
/**
 * Plugin Name: News Sitemap
 * Description: Generates a Google News compatible sitemap for WordPress sites to be submitted to Google Search Console. Creates XML sitemaps in Google News format for better news content indexing.
 * Version: 1.0.3
...
function activate_news_sitemap() {
    ...
    add_rewrite_rule('^news-sitemap\.xml$', 'index.php?newssitemap_xml=1', 'top');
...
class NewsSitemap_Generator {
    ...
    public function intercept_sitemap_request() {
        ...
        if ($path === '/news-sitemap.xml' || 
            preg_match('#/news-sitemap\.xml$#i', $path)) {
    ...
    public function generate_sitemap() {
        ...
        // Add notice
        echo "<!-- Google News compatible sitemap generated by News Sitemap Plugin -->\n";
    ...
    public function settings_section_callback() {
        ...
        echo '<p>Your sitemap is available at: <a href="' . esc_url(home_url('/news-sitemap.xml')) . '" target="_blank">' . esc_url(home_url('/news-sitemap.xml')) . '</a></p>';
        echo '<p>Alternative URL: <a href="' . esc_url(home_url('/?news_sitemap=1')) . '" target="_blank">' . esc_url(home_url('/?news_sitemap=1')) . '</a></p>';
    ...
    public function admin_page() {
        ...
        <div class="wrap">
            ...
            <ol>
                <li><strong>Primary URL:</strong> <a href="<?php echo esc_url(home_url('/news-sitemap.xml')); ?>" target="_blank"><?php echo esc_url(home_url('/news-sitemap.xml')); ?></a></li>
                <li><strong>Alternative URL:</strong> <a href="<?php echo esc_url(home_url('/?news_sitemap=1')); ?>" target="_blank"><?php echo esc_url(home_url('/?news_sitemap=1')); ?></a></li>
            </ol>
    ...
    public function add_plugin_action_links($links) {
        $settings_link = '<a href="' . admin_url('options-general.php?page=news-sitemap') . '">' . __('Settings', 'news-sitemap') . '</a>';
        $donate_link = '<a href="https://www.buymeacoffee.com/gunjanjaswal" target="_blank" style="color: #d63638; font-weight: bold;">' . __('☕ Buy me a coffee', 'news-sitemap') . '</a>';

<?php
/**
 * Plugin Name: News Sitemap XML for Google News
 ...
 * Text Domain: news-sitemap-xml-for-google-news
 */
...
function activate_news_sitemap() {
    ...
    add_rewrite_rule('^news-sitemap-xml-for-google-news\.xml$', 'index.php?newssitemap_xml=1', 'top');
...
class NewsSitemap_Generator {
    ...
    public function intercept_sitemap_request() {
        ...
        if ($path === '/news-sitemap-xml-for-google-news.xml' || 
            preg_match('#/news-sitemap-xml-for-google-news\.xml$#i', $path)) {
    ...
    public function add_admin_menu() {
        add_options_page(
            __('News Sitemap XML for Google News Settings', 'news-sitemap-xml-for-google-news'),
            __('News Sitemap XML for Google News', 'news-sitemap-xml-for-google-news'),
            'manage_options',
    ...
    public function register_settings() {
        ...
        add_settings_section(
            ...
            __('Google News Sitemap Settings', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            'publication_name',
            __('Publication Name', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            ...
            __('Publication Language', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            'post_types',
            __('Post Types', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            'categories',
            __('Categories', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            'max_age',
            __('Maximum Age (hours)', 'news-sitemap-xml-for-google-news'),
        ...
        add_settings_field(
            'max_posts',
            __('Maximum Posts', 'news-sitemap-xml-for-google-news'),
    ...
    public function settings_section_callback() {
        ...
        echo '<p>Your sitemap is available at: <a href="' . esc_url(home_url('/news-sitemap-xml-for-google-news.xml')) . '" target="_blank">' . esc_url(home_url('/news-sitemap-xml-for-google-news.xml')) . '</a></p>';
    ...
    public function admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html__('News Sitemap XML for Google News Settings', 'news-sitemap-xml-for-google-news'); ?></h1>
            ...
            <ol>
                <li><strong>Primary URL:</strong> <a href="<?php echo esc_url(home_url('/news-sitemap-xml-for-google-news.xml')); ?>" target="_blank"><?php echo esc_url(home_url('/news-sitemap-xml-for-google-news.xml')); ?></a></li>
    ...
    public function add_plugin_action_links($links) {
        $settings_link = '<a href="' . admin_url('options-general.php?page=news-sitemap-xml-for-google-news') . '">' . __('Settings', 'news-sitemap-xml-for-google-news') . '</a>';
        $donate_link = '<a href="https://www.buymeacoffee.com/gunjanjaswal" target="_blank" style="color: #d63638; font-weight: bold;">' . __('☕ Buy me a coffee', 'news-sitemap-xml-for-google-news') . '</a>';

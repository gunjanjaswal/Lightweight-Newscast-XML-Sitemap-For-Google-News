# Contributing to News Sitemap XML for Google News

Thank you for your interest in contributing to News Sitemap XML for Google News! This document provides guidelines and information for contributors.
...
├── news-sitemap-xml-for-google-news.php  # Main plugin file
├── uninstall.php                          # Cleanup on uninstall
├── readme.txt                             # WordPress.org readme
├── README.md                              # GitHub readme
├── CONTRIBUTING.md                        # This file
├── languages/                             # Translation files
│   └── news-sitemap-xml-for-google-news.pot
...
- Always use the correct text domain: `news-sitemap-xml-for-google-news`

### Example:
```php
// Good
echo '<h1>' . esc_html__('Settings', 'news-sitemap-xml-for-google-news') . '</h1>';
...
Thank you for contributing to News Sitemap XML for Google News! 🎉
